...
const int PS2_DAT = 12;                //gamepad port definitions
const int PS2_ATT = 10;
const int PS2_CMD = 11;
const int PS2_CLK = 13;
const int RUMBLE = true;
const int PRESSURES = true;

const int COXA1_SERVO  = 23;          //servo port definitions
const int FEMUR1_SERVO = 21;
const int TIBIA1_SERVO = 19;
const int COXA2_SERVO  = 29;
const int FEMUR2_SERVO = 27;
const int TIBIA2_SERVO = 25;
const int COXA3_SERVO  = 35;
const int FEMUR3_SERVO = 33;
const int TIBIA3_SERVO = 31;
const int COXA4_SERVO  = 41;
const int FEMUR4_SERVO = 39;
const int TIBIA4_SERVO = 37;
const int COXA5_SERVO  = 47;
const int FEMUR5_SERVO = 45;
const int TIBIA5_SERVO = 43;
const int COXA6_SERVO  = 53;
const int FEMUR6_SERVO = 51;                 
const int TIBIA6_SERVO = 49;
...
// Note: my hexapod uses a 3S LiPo batteryw
