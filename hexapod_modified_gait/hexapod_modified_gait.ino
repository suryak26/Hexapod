...
const int RED_LED1   = 3;            //LED port definitions
...
void process_gamepad()
{
  ...
  {
    if(gait_speed == 0) ;     //use green LEDs for fast
...
void tripod_gait()
{
  // Read commanded values from the controller
  ...
  {
    compute_strides();
    numTicks = round(duration / FRAME_TIME_MS / 2.0); // Total ticks divided into two cases
  ...
  // Consider removing or adjusting this delay
   // Shorter delay for smoother performance
}
